            ...
            <div className="mx-auto max-w-3xl text-base leading-7">
              ...
              <h2 className="mt-16 text-2xl font-bold tracking-tight">Technical Implementation</h2>
                ...
                <ul className="mt-4 space-y-2 list-none pl-6">
                  ...
                  <li className="flex items-center gap-2"><ScrollText className="w-4 h-4" /><a href="https://mint.lagunalabs.co/NEO_Litepaper.pdf" className="text-primary hover:underline">Primecore Litepaper</a></li>
                </ul>
